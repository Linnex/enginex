...
{block name=title}Meet the Team{/block}
...
{block name=content}	
	...
	<p>Julia holds a master's degree in International Economics from the George Washington University. She is proficient in multiple languages, including French, German, Indonesian, Japanese and Spanish. Julia lives with her husband and son in northern Virginia. When not working with Zidisha, Julia enjoys practicing Indonesian martial arts.</p>
	...
	<p>Volunteer Mentors are Zidisha borrowers or residents of borrowers' communities, who volunteer their time to assist new members to interact with our website. If you reside in a country where Zidisha has a lending program and are interested in becoming a volunteer mentor, please contact us at <a href="mailto:service@zidisha.org">service@zidisha.org.</a></p>
		
	{php} include_once("includes/team.php"); {/php}
	...
	<p style="margin-top:10px;">
		Zidisha's Virtual Volunteers work with our staff to review borrower applications, translate loan profiles and comments, and answer member questions.  Check out our <a href="microfinance/intern.html" target="_blank">Intern / Volunteer page</a> to learn more about our Virtual Volunteering program.<br /><br />
	...
	<p style="margin-top:10px;">
		Translation Volunteers translate borrower profiles and comments from local languages into English, and translate lender comments into local languages.  Their work makes communication between members of different linguistic backgrounds possible.<br /><br />
	...
	<p style="margin-top:10px;">Ronnie Cheng is a founder of <a href="https://www.codedoor.com/">CodeDoor</a>, a marketplace for freelance programmers that have contributed to open source. Prior to that, he worked at Facebook and Samasource, a social enterprise that connects people living in poverty with life-changing work opportunities via the Internet. He is a graduate of Columbia University, where he majored in Computer Science and minored in Economics. Ronnie is excited about Zidisha's mission, because if he doesn't want to pay 30% interest, then the developing world should be able to get a much better rate. You can contact Ronnie at <a href="mailto:ronniezidisha@gmail.com">ronniezidisha@gmail.com</a>.</p>
